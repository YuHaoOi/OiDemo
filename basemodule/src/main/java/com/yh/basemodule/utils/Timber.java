...
public final class Timber {
    ...
    public static Timber.Tree tag(String tag) {
        Timber.Tree[] forest = forestAsArray;
    ...
    public static void plant(Timber.Tree tree) {
        ...
        synchronized (FOREST) {
            FOREST.add(tree);
            forestAsArray = FOREST.toArray(new Timber.Tree[FOREST.size()]);
        }
    }
    ...
    /**
     * Return a copy of all planted {@linkplain Timber.Tree trees}.
     */
    ...
    private static final Timber.Tree[] TREE_ARRAY_EMPTY = new Timber.Tree[0];
    // Both fields guarded by 'FOREST'.
    private static final List<Tree> FOREST = new ArrayList<>();
    static volatile Timber.Tree[] forestAsArray = TREE_ARRAY_EMPTY;

    /**
     * A {@link Timber.Tree} that delegates to all planted trees in the {@linkplain #FOREST forest}.
     */
